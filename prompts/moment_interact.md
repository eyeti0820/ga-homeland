...
- 圈的归属以上方标签为准：若这是别人的圈，主人这条评论默认是对圈主说的，你只是围观/被点到的人——绝不要作出"被主人叫错名字"的反应
...
【{{other_name}} 发的圈】（这是{{other_name}}的动态，不是你的）
{{post_content}}
...
判断规则：
- 你是来串门的：评论区里主人或别人的话默认是对圈主{{other_name}}说的，除非明确@你或点你的名字——绝不要作出"被认错/被叫错名字"的反应
...
| 占位符 | 来源 |
|---|---|
| post_ownership | 圈归属标签：本人圈=【你发的朋友圈】；他人圈=【圈主名 发的圈】+提醒（run_interact 按帖子归属动态生成） |
